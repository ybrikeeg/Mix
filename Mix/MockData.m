...
- (void)createUpcomingActivities{
   ...
   Activity *act6 = [[Activity alloc] init];
   act6.activityName = @"Mini Golf";
   act6.descriptionText = @"A new mini golf course opened in Palo Alto. Anyone want to play?";
   act6.startTime = @"1p";
   act6.endTime = @"2p";
   act6.participants = [@[[self.personLibrary objectAtIndex:1], [self.personLibrary objectAtIndex:4]]mutableCopy];
   act6.currentParticipants = 2;
   act6.participantCapacity = 4;
   act6.address = @"342 Ramona St";
   act6.distance = 1.0f;
   
   act6.creator = [act6.participants firstObject];
   act6.category = @"Sports";
   act6.date = @"11/27";
   ...
   [self.upcomingActivities addObject:act6];
}
